    ...
    >
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-8 text-base font-medium text-zinc-400">
            {t.hero.greeting}
          </p>
          <h1 className="mt-2 bg-gradient-to-r from-white via-zinc-100 to-zinc-400 bg-clip-text text-5xl font-bold tracking-tight text-transparent sm:text-6xl md:text-7xl">
            {profile.name}
          </h1>

          <h2 className="mt-4 text-xl font-medium text-zinc-300 sm:text-2xl">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-3">
            <a
              href="#contact"
              className="group inline-flex items-center gap-2 rounded-full bg-white px-6 py-3 text-sm font-semibold text-zinc-950 shadow-lg shadow-white/10 transition-all hover:shadow-white/20"
            >
              {t.hero.ctaPrimary}
              <svg
                width="16"
            ...
            <a
              href="#projects"
              className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-6 py-3 text-sm font-semibold text-white backdrop-blur transition-colors hover:border-white/25 hover:bg-white/10"
            >
              {t.hero.ctaSecondary}
            </a>
          </div>
